// This file comes from HiddenMonk: https://answers.unity.com/answers/1156088/view.html
...
public static class ExtDebug
{
	...
	public static void DrawBoxCastOnHit(Vector3 origin, Vector3 halfExtents, Quaternion orientation, Vector3 direction, float hitInfoDistance, Color color, float duration = 0f)
	{
	...
	public static void DrawBoxCastBox(Vector3 origin, Vector3 halfExtents, Quaternion orientation, Vector3 direction, float distance, Color color, float duration = 0f)
	{
		direction.Normalize();
	...
	public struct Box
	{
		...
		{
			//halfExtents /= 2; 	// This line is from LuLuKo from link at top of page.
